"""
HASS Control Android notification service.
...
REGISTRATIONS_FILE = 'hass_control_registrations.conf'


SERVER_KEY = 'server_key'
DEFAULT_SERVER_KEY = 'this_wont_be_used'
ATTR_TOKEN = 'token'
...
class FCMAndroidRegistrationView(HomeAssistantView):
    ...
    url = '/api/notify.hass-control'
    name = 'api:notify.hass-control'
...
class FCMAndroidCallbackView(HomeAssistantView):
    ...
    requires_auth = False
    url = '/api/notify.hass-control/callback'
    name = 'api:notify.hass-control/callback'
